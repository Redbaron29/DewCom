...
public class ReceivedMessageListAdapter extends RecyclerView.Adapter<ReceivedMessageListAdapter.RoomViewHolder> {
    ...
    public void setReceivedMessages(List<ReceivedMessage> receivedMessage) {
        mReceivedMessages = receivedMessage;
     ...
     */
    public ReceivedMessage getReceivedMessageAtPosition(int position) {
        return mReceivedMessages.get(position);
    }
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        ReceivedMessageListAdapter.clickListener = clickListener;
    }
