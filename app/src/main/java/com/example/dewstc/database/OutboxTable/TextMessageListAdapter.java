...
public class TextMessageListAdapter extends RecyclerView.Adapter<TextMessageListAdapter.RoomViewHolder> {

    private final LayoutInflater mInflater;
    private List<TextMessage> mTextMessages; // Cached copy of messages
    private static ClickListener clickListener;
    public TextMessageListAdapter(Context context) {
    ...
    public void onBindViewHolder(RoomViewHolder holder, int position) {
        if (mTextMessages != null) {
            TextMessage current = mTextMessages.get(position);
            holder.roomItemView.setText(current.getTextMessage() + "\n");
        } else {
    ...
    */
     ...
     */
    public TextMessage getMessageAtPosition(int position) {
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        TextMessageListAdapter.clickListener = clickListener;
    }
